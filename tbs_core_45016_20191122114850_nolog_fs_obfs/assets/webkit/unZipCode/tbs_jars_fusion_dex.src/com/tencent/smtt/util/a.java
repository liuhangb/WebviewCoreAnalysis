...
public class a
{
  ...
  public byte[] a(byte[] paramArrayOfByte1, int paramInt1, int paramInt2, byte[] paramArrayOfByte2)
  {
    ...
    if (paramInt2 % 8 == 0)
    {
      ...
      byte[] arrayOfByte = this.jdField_b_of_type_ArrayOfByte;
      if (arrayOfByte != null) {
        this.jdField_c_of_type_Int = (arrayOfByte[0] & 0x7);
      }
...
/* Location:              C:\Users\Administrator\Desktop\学习资料\dex2jar\dex2jar-2.0\classes-dex2jar.jar!\com\tencent\smtt\util\a.class
