  ...
  extends Struct
{
  ...
  private QueryVersionResult(int paramInt)
  {
    super(16, paramInt);
  }
  
  public static QueryVersionResult a(Decoder paramDecoder)
  {
    ...
    try
    {
      ...
      QueryVersionResult localQueryVersionResult = new QueryVersionResult(localDataHeader.b);
      if (localDataHeader.b >= 0) {
        localQueryVersionResult.jdField_a_of_type_Int = paramDecoder.a(8);
      }
      return localQueryVersionResult;
    }
    finally
    {
      paramDecoder.b();
  ...
  public boolean equals(Object paramObject)
  {
    ...
    paramObject = (QueryVersionResult)paramObject;
    return this.jdField_a_of_type_Int == ((QueryVersionResult)paramObject).jdField_a_of_type_Int;
  }
...
/* Location:              C:\Users\Administrator\Desktop\学习资料\dex2jar\dex2jar-2.0\classes-dex2jar.jar!\org\chromium\mojo\bindings\interfacecontrol\QueryVersionResult.class
