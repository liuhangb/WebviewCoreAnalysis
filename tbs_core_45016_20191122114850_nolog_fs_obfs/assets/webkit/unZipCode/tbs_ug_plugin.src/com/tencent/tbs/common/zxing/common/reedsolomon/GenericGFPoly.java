  ...
  GenericGFPoly(GenericGF paramGenericGF, int[] paramArrayOfInt)
  {
    if (paramArrayOfInt.length != 0)
    {
      ...
      if ((j > 1) && (paramArrayOfInt[0] == 0))
      {
        ...
        paramGenericGF = this.coefficients;
...
/* Location:              C:\Users\Administrator\Desktop\学习资料\dex2jar\dex2jar-2.0\classes-dex2jar.jar!\com\tencent\tbs\common\zxing\common\reedsolomon\GenericGFPoly.class
