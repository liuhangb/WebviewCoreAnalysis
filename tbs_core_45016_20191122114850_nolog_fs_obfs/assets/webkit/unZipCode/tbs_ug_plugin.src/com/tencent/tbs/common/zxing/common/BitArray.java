  ...
  implements Cloneable
{
  ...
  public int getNextUnset(int paramInt)
  {
    ...
    int j = paramInt / 32;
    i = ((1 << (paramInt & 0x1F)) - 1 ^ 0xFFFFFFFF) & (this.bits[j] ^ 0xFFFFFFFF);
    paramInt = j;
    while (i == 0)
    {
      paramInt += 1;
...
/* Location:              C:\Users\Administrator\Desktop\学习资料\dex2jar\dex2jar-2.0\classes-dex2jar.jar!\com\tencent\tbs\common\zxing\common\BitArray.class
