  ...
  implements Encoder
{
  ...
  public void encode(EncoderContext paramEncoderContext)
  {
    ...
    while (paramEncoderContext.hasMoreCharacters())
    {
      ...
      if ((localStringBuilder1.length() % 3 == 0) && (HighLevelEncoder.lookAheadTest(paramEncoderContext.getMessage(), paramEncoderContext.pos, getEncodingMode()) != getEncodingMode())) {
...
/* Location:              C:\Users\Administrator\Desktop\学习资料\dex2jar\dex2jar-2.0\classes-dex2jar.jar!\com\tencent\tbs\common\zxing\datamatrix\encoder\C40Encoder.class
