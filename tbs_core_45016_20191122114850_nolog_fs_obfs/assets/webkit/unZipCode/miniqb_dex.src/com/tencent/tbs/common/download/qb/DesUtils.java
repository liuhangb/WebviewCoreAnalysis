...
public class DesUtils
{
  ...
  private static final byte[] KEY = { -25, -101, -115, 1, 47, 7, -27, -59, 18, -128, 123, 79, -44, 37, 46, 115 };
  private static final int[] LeftMove;
  private static final byte[] MAC_KEY = { 37, -110, 60, 127, 42, -27, -17, -110 };
  private static final byte[] MTT_KEY = { -122, -8, -23, -84, -125, 113, 84, 99 };
  ...
  private static final byte[] QQMARKET_KEY = "AL!#$AC9Ahg@KLJ1".getBytes();
  private static final byte[] REPORT_KEY_TEA;
  ...
  static
  {
    ...
    Object localObject2 = { 4, 1, 14, 8, 13, 6, 2, 11, 15, 12, 9, 7, 3, 10, 5, 0 };
    localObject1 = new int[][] { localObject1, { 0, 15, 7, 4, 14, 2, 13, 1, 10, 6, 12, 11, 9, 5, 3, 8 }, localObject2, { 15, 12, 8, 2, 4, 9, 1, 7, 5, 11, 3, 14, 10, 0, 6, 13 } };
    ...
    int[] arrayOfInt2 = { 3, 15, 0, 6, 10, 1, 13, 8, 9, 4, 5, 11, 12, 7, 2, 14 };
    localObject3 = new int[][] { localObject3, { 13, 8, 11, 5, 6, 15, 0, 3, 4, 7, 2, 12, 1, 10, 14, 9 }, localObject4, arrayOfInt2 };
    localObject4 = new int[][] { { 2, 12, 4, 1, 7, 10, 11, 6, 8, 5, 3, 15, 13, 0, 14, 9 }, { 14, 11, 2, 12, 4, 7, 13, 1, 5, 0, 15, 10, 3, 9, 8, 6 }, { 4, 2, 1, 11, 10, 13, 7, 8, 15, 9, 12, 5, 6, 3, 0, 14 }, { 11, 8, 12, 7, 1, 14, 2, 13, 6, 15, 0, 9, 10, 4, 5, 3 } };
    arrayOfInt2 = new int[] { 12, 1, 10, 15, 9, 2, 6, 8, 0, 13, 3, 4, 14, 7, 5, 11 };
    int[] arrayOfInt3 = { 4, 3, 2, 12, 9, 5, 15, 10, 11, 14, 1, 7, 6, 0, 8, 13 };
    int[][] arrayOfInt5 = { arrayOfInt2, { 10, 15, 4, 2, 7, 12, 9, 5, 6, 1, 13, 14, 0, 11, 3, 8 }, { 9, 14, 15, 5, 2, 8, 12, 3, 7, 0, 4, 10, 1, 13, 11, 6 }, arrayOfInt3 };
    ...
    arrayOfInt2 = new int[] { 13, 2, 8, 4, 6, 15, 11, 1, 10, 9, 3, 14, 5, 0, 12, 7 };
    arrayOfInt3 = new int[] { 1, 15, 13, 8, 10, 3, 7, 4, 12, 5, 6, 11, 0, 14, 9, 2 };
    int[] arrayOfInt4 = { 2, 1, 14, 7, 4, 10, 8, 13, 15, 12, 9, 0, 3, 5, 6, 11 };
    S_Box = new int[][][] { localObject1, localObject2, arrayOfInt1, localObject3, localObject4, arrayOfInt5, arrayOfInt6, { arrayOfInt2, arrayOfInt3, { 7, 11, 4, 1, 9, 12, 14, 2, 0, 6, 10, 13, 15, 3, 5, 8 }, arrayOfInt4 } };
    ...
    for (;;)
    {
      try
      {
        ...
        if (i < j)
        {
          ...
          System.arraycopy(UnitDes(arrayOfByte3, arrayOfByte4, paramInt), 0, arrayOfByte1, k, 8);
          i += 1;
          continue;
        }
...
/* Location:              C:\Users\Administrator\Desktop\学习资料\dex2jar\dex2jar-2.0\classes-dex2jar.jar!\com\tencent\tbs\common\download\qb\DesUtils.class
