  ...
  extends Struct
{
  ...
  private QueryVersion(int paramInt)
  {
    super(8, paramInt);
  }
  
  public static QueryVersion a(Decoder paramDecoder)
  {
    ...
    try
    {
      QueryVersion localQueryVersion = new QueryVersion(paramDecoder.a(jdField_a_of_type_ArrayOfOrgChromiumMojoBindingsDataHeader).b);
      return localQueryVersion;
    }
    finally
    {
      paramDecoder.b();
...
/* Location:              C:\Users\Administrator\Desktop\学习资料\dex2jar\dex2jar-2.0\classes-dex2jar.jar!\org\chromium\mojo\bindings\interfacecontrol\QueryVersion.class
