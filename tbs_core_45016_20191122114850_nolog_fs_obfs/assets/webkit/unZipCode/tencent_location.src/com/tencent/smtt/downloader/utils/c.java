...
public class c
{
  ...
  static
  {
    ...
    int[] arrayOfInt21 = { 14, 4, 13, 1, 2, 15, 11, 8, 3, 10, 6, 12, 5, 9, 0, 7 };
    int[] arrayOfInt22 = { 0, 15, 7, 4, 14, 2, 13, 1, 10, 6, 12, 11, 9, 5, 3, 8 };
    int[] arrayOfInt23 = { 4, 1, 14, 8, 13, 6, 2, 11, 15, 12, 9, 7, 3, 10, 5, 0 };
    int[] arrayOfInt24 = { 15, 12, 8, 2, 4, 9, 1, 7, 5, 11, 3, 14, 10, 0, 6, 13 };
    int[] arrayOfInt17 = { 15, 1, 8, 14, 6, 11, 3, 4, 9, 7, 2, 13, 12, 0, 5, 10 };
    int[] arrayOfInt18 = { 3, 13, 4, 7, 15, 2, 8, 14, 12, 0, 1, 10, 6, 9, 11, 5 };
    int[] arrayOfInt19 = { 0, 14, 7, 11, 10, 4, 13, 1, 5, 8, 12, 6, 9, 3, 2, 15 };
    int[] arrayOfInt20 = { 13, 8, 10, 1, 3, 15, 4, 2, 11, 6, 7, 12, 0, 5, 14, 9 };
    ...
    int[] arrayOfInt10 = { 13, 8, 11, 5, 6, 15, 0, 3, 4, 7, 2, 12, 1, 10, 14, 9 };
    int[] arrayOfInt11 = { 10, 6, 9, 0, 12, 11, 7, 13, 15, 1, 3, 14, 5, 2, 8, 4 };
    int[] arrayOfInt12 = { 3, 15, 0, 6, 10, 1, 13, 8, 9, 4, 5, 11, 12, 7, 2, 14 };
    int[] arrayOfInt5 = { 2, 12, 4, 1, 7, 10, 11, 6, 8, 5, 3, 15, 13, 0, 14, 9 };
    int[] arrayOfInt6 = { 11, 8, 12, 7, 1, 14, 2, 13, 6, 15, 0, 9, 10, 4, 5, 3 };
    int[] arrayOfInt1 = { 12, 1, 10, 15, 9, 2, 6, 8, 0, 13, 3, 4, 14, 7, 5, 11 };
    int[] arrayOfInt2 = { 4, 3, 2, 12, 9, 5, 15, 10, 11, 14, 1, 7, 6, 0, 8, 13 };
    int[] arrayOfInt3 = { 4, 11, 2, 14, 15, 0, 8, 13, 3, 12, 9, 7, 5, 10, 6, 1 };
    int[] arrayOfInt4 = { 1, 4, 11, 13, 12, 3, 7, 14, 10, 15, 6, 8, 0, 5, 9, 2 };
    ...
    jdField_a_of_type_Array3dOfInt = new int[][][] { { arrayOfInt21, arrayOfInt22, arrayOfInt23, arrayOfInt24 }, { arrayOfInt17, arrayOfInt18, arrayOfInt19, arrayOfInt20 }, { { 10, 0, 9, 14, 6, 3, 15, 5, 1, 13, 12, 7, 11, 4, 2, 8 }, arrayOfInt7, arrayOfInt8, arrayOfInt9 }, { { 7, 13, 14, 3, 0, 6, 9, 10, 1, 2, 8, 5, 11, 12, 4, 15 }, arrayOfInt10, arrayOfInt11, arrayOfInt12 }, { arrayOfInt5, { 14, 11, 2, 12, 4, 7, 13, 1, 5, 0, 15, 10, 3, 9, 8, 6 }, { 4, 2, 1, 11, 10, 13, 7, 8, 15, 9, 12, 5, 6, 3, 0, 14 }, arrayOfInt6 }, { arrayOfInt1, { 10, 15, 4, 2, 7, 12, 9, 5, 6, 1, 13, 14, 0, 11, 3, 8 }, { 9, 14, 15, 5, 2, 8, 12, 3, 7, 0, 4, 10, 1, 13, 11, 6 }, arrayOfInt2 }, { arrayOfInt3, { 13, 0, 11, 7, 4, 9, 1, 10, 14, 3, 5, 12, 2, 15, 8, 6 }, arrayOfInt4, { 6, 11, 13, 8, 1, 4, 10, 7, 9, 5, 0, 15, 14, 2, 3, 12 } }, { arrayOfInt13, arrayOfInt14, arrayOfInt15, arrayOfInt16 } };
  ...
  private static void a(int[] paramArrayOfInt, int paramInt)
  {
    ...
    if (paramInt == 1)
    {
      for (paramInt = 0; paramInt < 27; paramInt = i)
      {
        i = paramInt + 1;
        arrayOfInt3[paramInt] = arrayOfInt1[i];
        arrayOfInt4[paramInt] = arrayOfInt2[i];
      }
    ...
    for (;;)
    {
      try
      {
        ...
        if (i < j)
        {
          ...
          k = i * 8;
          System.arraycopy(arrayOfByte2, k, arrayOfByte4, 0, 8);
          System.arraycopy(b(arrayOfByte3, arrayOfByte4, paramInt), 0, arrayOfByte1, k, 8);
          i += 1;
          continue;
        }
  ...
  private static byte[] a(int[] paramArrayOfInt, int paramInt, int[][] paramArrayOfInt1)
  {
    ...
    if (paramInt == 1)
    {
      ...
      for (;;)
      {
        ...
        a(arrayOfInt1, j, paramInt, paramArrayOfInt1);
        j += 1;
      }
    }
    i = k;
    ...
    while (i < 64)
    {
      arrayOfInt2[i] = arrayOfInt1[(jdField_b_of_type_ArrayOfInt[i] - 1)];
      i += 1;
    }
...
/* Location:              C:\Users\Administrator\Desktop\学习资料\dex2jar\dex2jar-2.0\classes-dex2jar.jar!\com\tencent\smtt\downloader\utils\c.class
