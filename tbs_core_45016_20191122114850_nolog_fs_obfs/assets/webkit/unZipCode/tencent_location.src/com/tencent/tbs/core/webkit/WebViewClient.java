  ...
  private void onUnhandledInputEventInternal(WebView paramWebView, InputEvent paramInputEvent)
  {
    ...
    if (paramWebView != null) {
      try
      {
        ...
        {
          paramWebView.getClass().getMethod("dispatchUnhandledKey", new Class[] { KeyEvent.class }).invoke(paramWebView, new Object[] { (KeyEvent)paramInputEvent });
          return;
        }
      }
...
/* Location:              C:\Users\Administrator\Desktop\学习资料\dex2jar\dex2jar-2.0\classes-dex2jar.jar!\com\tencent\tbs\core\webkit\WebViewClient.class
