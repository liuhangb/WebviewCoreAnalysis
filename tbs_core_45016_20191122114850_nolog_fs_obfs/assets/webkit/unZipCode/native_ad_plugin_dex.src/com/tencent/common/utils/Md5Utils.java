...
public class Md5Utils
{
  ...
  public static String getMD5(java.io.File paramFile)
  {
    ...
    //   74: invokestatic 51	com/tencent/common/utils/ByteUtils:byteToHexString	([B)Ljava/lang/String;
    //   77: astore_2
    //   78: aload_0
  ...
  public static byte[] getMD5(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    try
    {
      MessageDigest localMessageDigest = MessageDigest.getInstance("MD5");
...
/* Location:              C:\Users\Administrator\Desktop\学习资料\dex2jar\dex2jar-2.0\classes-dex2jar.jar!\com\tencent\common\utils\Md5Utils.class
